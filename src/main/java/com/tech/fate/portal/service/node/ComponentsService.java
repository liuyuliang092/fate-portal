 ...
 */
package com.tech.fate.portal.service.node;
...
public interface ComponentsService {
    List<ComponentsVo> algorithmComponents();

    ComponentsParams queryAlgorithmComponentsParams(String nodeId);

    List<ComponentsParamsSettings> queryAlgorithmComponentsParamsSettings(String projectUuid, String taskUuid, String dslNodeId);

    void saveAlgorithmComponentsParamsSettings(ComponentsParamsSettings componentsParamsSettings);
