...
public interface LocalDataService {
     ...
     * @throws Exception
     */
    void uploadData(MultipartFile file, String name, String description)throws Exception;
     ...
     * @throws IOException
     */
    int saveData(MultipartFile file,String result,String name,String description)throws Exception;
